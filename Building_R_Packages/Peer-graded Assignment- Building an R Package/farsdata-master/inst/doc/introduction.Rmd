...
library(farsdata)
```
This package encapsulate functions that vary between reading in .csv files and processing the FARS to explore 2013, 2014 and 2015 data from the National Highway Traffic Safety Administration (NHTSA) Fatality Analysis Reporting System (FARS). This package was written for the Week 4 final assignment for the “Building R Packages” course on Coursera, as part of the Johns Hopkins University “Mastering Software Development in R” specialization. The functions in this package include:

Reading FARS csv data files Create canonical filenmae Make list of data.frames for each year Summarize FARS data set by year and each month in year Graphical map of fatalities in FARS data STATE and year
